...
interface SectorAnalystPhaseDetailsProps {
  ...
  analysisData?: {
    ...
    worstSectors?: Array<{ name: string; performance: string; outlook: string }>
  } | null
}

export function SectorAnalystPhaseDetails({ analysisData }: SectorAnalystPhaseDetailsProps) {
  return (
      ...
      <Card className="border-orange-500/30 bg-orange-500/5">
        ...
        <CardContent>
          ...
          <div className="space-y-3">
            <div>
              <p className="text-xs text-muted-foreground mb-2">Top Performing Sectors</p>
