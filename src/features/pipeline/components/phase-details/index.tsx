...
function getPhaseType(phaseName: string): string {
	...
	if (lower.includes("phase 3") || lower.includes("ihsg analyst")) return "ihsg_analyst";
	if (lower.includes("phase 4") || lower.includes("sector analyst")) return "sector_analyst";
	if (lower.includes("phase 5") || lower.includes("stock screener")) return "stock_screener";
	if (lower.includes("phase 6") || lower.includes("stock analyst")) return "stock_analyst";
	if (lower.includes("phase 7") || lower.includes("fundamental analyst")) return "fundamental_analyst";
	...
	if (
		...
		return (
			<Card>
				...
				<CardContent>
					<p className="text-sm text-muted-foreground">This phase does not have any stored details yet.</p>
				</CardContent>
			</Card>
		);
	}
