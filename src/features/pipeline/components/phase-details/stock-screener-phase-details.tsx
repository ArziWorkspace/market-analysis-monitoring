...
export function StockScreenerPhaseDetails({
  stockScreener,
  stockPicks,
}: StockScreenerPhaseDetailsProps) {
      ...
      {stockScreener && (
        <>
          ...
          {stockScreener.stock_picks && (
            <JsonCard
              title="Stock Picks (JSON)"
              data={stockScreener.stock_picks}
            />
          )}

          {stockScreener.eliminated_stocks && (
            <JsonCard
              title="Eliminated Stocks"
              data={stockScreener.eliminated_stocks}
            />
          )}
        </>
      )}
