...
CREATE TABLE "Role" (
    ...
    "name" TEXT NOT NULL,
    "description" TEXT,
    "byPassAllFeatures" BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE "Permission" (
    ...
    "parentId" INTEGER,
    "showOnSidebar" BOOLEAN NOT NULL DEFAULT false,
    "isActive" BOOLEAN NOT NULL DEFAULT true,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE INDEX "Permission_sequence_idx" ON "Permission"("sequence");
